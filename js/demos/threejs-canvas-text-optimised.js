define([
    ...
    var demo = {
        ...
        id: 'threejs-canvas-text-optimised',
        ...
        constructor: function() {
            ...
            function init() {
                ...
                container = document.getElementById('container-canvas-text-optimised');
                ...
                for( var i=0; i < 16; i++ ) {
                    ...
                    /*** curveSegments optimisation ***/
                    var labelGeo = new THREE.ShapeGeometry( labelShapes, {curveSegments: 1} );
            ...
            function onMouseDown(event) {
                ...
                handleClickOrTap({x: (event.clientX - offsetLeft) / width,
                    y: (event.clientY - offsetTop) / height});
